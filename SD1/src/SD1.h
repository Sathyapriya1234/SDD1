...
class File : public Stream {
 private:
  ...
  SdFile1 *_file;  // underlying file pointer

public:
  File(SdFile1 f, const char *name);     // wraps an underlying SdFile
...
private:
  ...
  SdFile1 getParentDir(const char *filepath, int *indx);
public:
...
private:
  ...
  friend class File;
  friend boolean callback_openPath1(SdFile1&, const char *, boolean, void *); 
};
...
typedef SDLib1::File    SDFile;
typedef SDLib1::SDClass SDFileSystemClass;
#define SDFileSystem   SDLib1::SD1
